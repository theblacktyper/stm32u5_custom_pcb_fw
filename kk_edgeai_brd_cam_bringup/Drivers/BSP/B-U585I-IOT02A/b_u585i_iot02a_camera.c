...
/** @addtogroup B_U585I_IOT02A_CAMERA
  * @{
  */

/** @defgroup B_U585I_IOT02A_CAMERA_Exported_Variables CAMERA Exported Variables
  * @{
  */
...
/** @defgroup B_U585I_IOT02A_CAMERA_Private_Variables CAMERA Private Variables
  * @{
  */
...
/** @defgroup B_U585I_IOT02A_CAMERA_Private_FunctionsPrototypes CAMERA Private Functions Prototypes
  * @{
  */
...
/** @defgroup B_U585I_IOT02A_CAMERA_Exported_Functions CAMERA Exported Functions
  * @{
  */
...
int32_t BSP_CAMERA_Init(uint32_t Instance, uint32_t Resolution, uint32_t PixelFormat)
{
  ...
  else
  {
    ...
    {
//      if (HAL_GPIO_ReadPin(CAM_PLUG_PORT, CAM_PLUG_PIN) == GPIO_PIN_SET)
//      {
...
/** @defgroup B_U585I_IOT02A_CAMERA_Private_Functions CAMERA Private Functions
  * @{
  */
