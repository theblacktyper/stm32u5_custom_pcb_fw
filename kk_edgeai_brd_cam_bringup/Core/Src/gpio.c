...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(CAMERA_XSDN_GPIO_Port, CAMERA_XSDN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, CAMERA_RSTI_Pin|GRN_LED1_Pin|RED_LED2_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : CAMERA_XSDN_Pin GRN_LED1_Pin RED_LED2_Pin */
  GPIO_InitStruct.Pin = CAMERA_XSDN_Pin|GRN_LED1_Pin|RED_LED2_Pin;
