/**
  ...
  ******************************************************************************
  */
#ifndef AI_P_DET_MODEL_H
#define AI_P_DET_MODEL_H

#include "p_det_model_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_P_DET_MODEL_MODEL_NAME          "p_det_model"
#define AI_P_DET_MODEL_ORIGIN_MODEL_NAME   "mobilenet_v2_0_35_128_fft_int8_image_classification_person"

/******************************************************************************/
#define AI_P_DET_MODEL_ACTIVATIONS_ALIGNMENT   (4)
#define AI_P_DET_MODEL_INPUTS_IN_ACTIVATIONS   (4)
#define AI_P_DET_MODEL_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_P_DET_MODEL_IN_NUM        (1)

AI_DEPRECATED
#define AI_P_DET_MODEL_IN \
  ai_p_det_model_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_P_DET_MODEL_IN_SIZE { \
  AI_P_DET_MODEL_IN_1_SIZE, \
}
#define AI_P_DET_MODEL_IN_SIZE_BYTES { \
  AI_P_DET_MODEL_IN_1_SIZE_BYTES, \
}
#define AI_P_DET_MODEL_IN_1_FORMAT      (AI_BUFFER_FORMAT_U8)
#define AI_P_DET_MODEL_IN_1_HEIGHT      (128)
#define AI_P_DET_MODEL_IN_1_WIDTH       (128)
#define AI_P_DET_MODEL_IN_1_CHANNEL     (3)
#define AI_P_DET_MODEL_IN_1_SIZE        (49152)
#define AI_P_DET_MODEL_IN_1_SIZE_BYTES  (49152)

/******************************************************************************/
#define AI_P_DET_MODEL_OUT_NUM       (1)

AI_DEPRECATED
#define AI_P_DET_MODEL_OUT \
  ai_p_det_model_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_P_DET_MODEL_OUT_SIZE { \
  AI_P_DET_MODEL_OUT_1_SIZE, \
}
#define AI_P_DET_MODEL_OUT_SIZE_BYTES { \
  AI_P_DET_MODEL_OUT_1_SIZE_BYTES, \
}
#define AI_P_DET_MODEL_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_P_DET_MODEL_OUT_1_CHANNEL     (1)
#define AI_P_DET_MODEL_OUT_1_SIZE        (1)
#define AI_P_DET_MODEL_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_P_DET_MODEL_N_NODES (84)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup p_det_model
 ...
 * @ref ai_p_det_model_create. Both the activations memory buffer 
 ...
 * using @ref ai_p_det_model_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_p_det_model_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_p_det_model_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_P_DET_MODEL_*
 * defines into file @ref p_det_model.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_p_det_model_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_P_DET_MODEL_H */
